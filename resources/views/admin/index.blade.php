	        ...
	        <div class="tab-content mar-top">
                                    	...
                                    	@foreach($users as $user)
                                    		@if($i <= 5)
	                                            <tr>
	                                                ...
	                                                <td>{{ $user->name }}</td>
	                                                <td>{{ $user->email }}</td>
	                                                <td class="text-center">{{ App\Models\Role::where('name',$user->role)->first()->display_name }}</td>
	                                                <td>
	            ...
	            <div id="tab2" class="tab-pane fade">
	                <div class="row">
                        <div class="portlet-title" style="margin-top: 2px;">
                            <div class="caption">
                                <i class="livicon" data-name="warning" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> User Roles
                            </div>
                        </div>
                        <div class="portlet-body">
