...
@section('title') System Role ({{ $role->display_name }}) @endsection
@section('styles')
        ...
        <div class="col-md-8">
            <div class="panel panel-danger" id="hidepanel1">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('roles.update', $role->id) }}" method="POST" style="max-height: 450px; overflow-y: auto;">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="name" type="text" placeholder="Names" value="{{ $role->name }}" class="form-control" autofocus required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">Display Name</label>
                                <div class="col-md-9">
                                    <input id="name" name="display_name" type="text" placeholder="Names" value="{{ $role->display_name }}" class="form-control" autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">Description</label>
                                <div class="col-md-9">
                                    <textarea id="description" name="description" placeholder="Role Description" class="form-control" autofocus>{{ $role->description }}</textarea>
                                </div>
                            </div>
