...
@section('title') Add Disease Records @endsection
@section('styles')
...
@endsection
@section('location')
	<h1>The Disease Cases Stored In The System</h1>
    <ol class="breadcrumb">
        <li>
            <a href="{{ route('home') }}">
        ...
        <div class="col-md-9 col-sm-8">
            <div class="panel panel-danger" id="hidepanel1">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('cases.store') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="case_name" type="text" placeholder="Enter disease case name" class="form-control" autofocus required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="tretmt" name="treatment_plan" type="text" placeholder="Enter treament plan" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="name">Case Id</label>
                                <div class="col-md-9">
                                    <input id="caseid" name="case_id" type="text" placeholder="Enter case ID" class="form-control">
                                </div>
                            </div>
                            <!-- Message body -->
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control resize_vertical" id="message" name="description" placeholder="Describe the disease case in few sentences." rows="5"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 text-right">
                                    <div class="col-md-4 pull-right">
                                        <button type="submit" class="btn btn-responsive btn-danger btn-sm btn-block">Add Disease Case Record</button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
