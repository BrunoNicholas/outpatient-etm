...
@section('title') Edit Pattern Track @endsection
@section('styles')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <a href="javascript:void(0)">
                <i class="livicon" data-name="pencil" data-size="14" data-color="#333" data-hovercolor="#333"></i> Edit Pattern Track
            </a>
        </li>
    </ol>
@endsection
